...
export const features: CardItem[] = [
	...
	{
		title: 'Заметки',
		desc: 'Легкие текстовые записи с быстрым сохранением, удобным просмотром и упорядочиванием.',
		Icon: StickyNote,
	},

	{
		title: 'Конвертер валют',
		desc: 'Двусторонний конвертер валют с удобным копированием текущего курса и результата.',
		Icon: CircleDollarSign,
	},
	{
		title: 'Погода',
		desc: 'Точный прогноз на день и неделю с автолокацией и мгновенным обновлением данных.',
		Icon: CloudSun,
	},
	{
		title: 'Переводчик',
	...
	{
		title: 'Канбан',
		desc: 'Гибкая доска задач: сроки, статусы, приоритеты. Идеально для личных и командных процессов.',
		Icon: KanbanSquare,
	},
	{
		title: 'ToDo',
		desc: 'Простое управление задачами: статусы, приоритеты и напоминания в минималистичном интерфейсе.',
		Icon: ListChecks,
	},
	{
		title: 'OneGen',
		desc: 'Быстрый генератор SVG-карточек: создание аккуратных сеток за считанные минуты.',
		Icon: PencilRuler,
	},
];
...
export const principles: CardItem[] = [
	{
		title: 'Чистая архитектура',
		desc: 'Модульная структура с четкими границами. Код легко понимать, тестировать и развивать.',
		Icon: Layers,
	},
	{
	...
	},
	{
		...
		desc: 'Фокус на ключевых сценариях. Минимум лишнего, максимум удобства и доступности.',
		Icon: AppWindow,
	},
	{
		title: 'Мобильная отзывчивость',
		desc: 'Интерфейс адаптируется под любые экраны и устройства, сохраняя удобство, комфорт и читаемость.',
		Icon: Smartphone,
	},
	{
		title: 'Стабильность и надежность',
		desc: 'Возможные ошибки обрабатываются предсказуемо, интерфейс устойчив к сбоям и некорректным данным.',
		Icon: Shield,
	},
	{
		title: 'Прозрачность данных',
		desc: 'Пользователь всегда видит, что происходит с его данными – вход, сохранение, обновление.',
		Icon: Eye,
	},
];

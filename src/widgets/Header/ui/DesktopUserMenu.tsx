...
export const DesktopUserMenu = observer(() => {
	...
	return (
		<div className="core-elements absolute right-0 flex w-xs flex-col rounded-xl rounded-t-none py-2 shadow-[inset_0_16px_6px_-4px_rgba(0,0,0,0.2)]">
			<UserMenuInfo className="mt-2.5 px-4 py-2" />
			<Divider className="opacity-60" padX="md" padY="sm" />

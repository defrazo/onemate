			...
			<div className="flex flex-1 py-2">
				<div className="flex flex-1 flex-col gap-2">
					<div className="flex h-full flex-col items-center justify-center md:flex-row">
						<ConditionIcon
							className="-mb-2 size-15 md:mb-0 md:size-25"
							condition={weather[0].icon as ConditionCode}
							description={weather[0].description}
						/>
						<span className="text-3xl font-bold md:text-5xl">{Math.round(temp)}°C</span>
					</div>
					<div className="flex flex-col items-center justify-center gap-1 text-xs md:text-sm">
						<div className="text-center leading-3">{capitalizeFirstLetter(weather[0].description)}</div>
				...
				<div className="flex flex-col justify-between gap-4 px-2 text-xs md:text-base">

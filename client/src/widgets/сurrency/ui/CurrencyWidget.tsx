	...
	return (
		<>
			...
			{!currencyStore.isReady ? (
				...
				<>
					<div
						className="m-auto flex cursor-copy py-10 text-center text-2xl hover:text-(--accent-default) xl:p-0 xl:text-3xl 2xl:text-4xl"
					...
					<div
						className="mx-auto flex h-9 cursor-copy items-end text-xs text-(--color-disabled) hover:text-(--accent-default) lg:text-sm xl:text-base"
